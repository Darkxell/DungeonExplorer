...
public abstract class ImagesHolder {
    ...
    public static final BufferedImage ENTITIES_PLAYER = readfile(Res.FOLDER_PATH
	    + "entities/player.png");
    public static final BufferedImage ENTITIES_SLUGGULA = readfile(Res.FOLDER_PATH
	    + "entities/sluggula.png");
    public static final BufferedImage ENTITIES_OKTOROK = readfile(Res.FOLDER_PATH
	    + "entities/oktorok.png");
    public static final BufferedImage ENTITIES_BOULDER = readfile(Res.FOLDER_PATH
    ...
    public static final BufferedImage MENU_BACKGROUND = readfile(Res.FOLDER_PATH
	    + "mainmenu/background.png");
    public static final BufferedImage MENU_FILESELECT = readfile(Res.FOLDER_PATH
	    + "mainmenu/fileselect.png");
    public static final BufferedImage MENU_LIGHT = readfile(Res.FOLDER_PATH
	    + "mainmenu/light.png");
    public static final BufferedImage MENU_SELECTBG = readfile(Res.FOLDER_PATH
	    + "mainmenu/selectbackground.png");
    public static final BufferedImage MENU_START = readfile(Res.FOLDER_PATH
	    + "mainmenu/start.png");
    public static final BufferedImage MENU_SWORD = readfile(Res.FOLDER_PATH
	    + "mainmenu/sword.png");
    public static final BufferedImage MENU_TITLE = readfile(Res.FOLDER_PATH
	    + "mainmenu/title.png");
