...
public class GameFrame {
	...
	/**
	 * Changes the size of the frame the the desired value. This method changes the
	 * size of the frame, the inner canvas and the shadows.
	 */
